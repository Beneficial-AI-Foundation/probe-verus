...
- `probe:curve25519-dalek/4.1.3/edwards/CompressedEdwardsY#Debug<&core::fmt::Formatter<'_>>#fmt()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsBasepointTable#Clone#clone()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint#MultiscalarMul<J>#multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint#VartimeMultiscalarMul<J>#optional_multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint<I>#sum_original()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint#MultiscalarMul<J>#multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint#VartimeMultiscalarMul<J>#optional_multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint<&R>#random()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint<I>#sum_original()` (external-body)
- `probe:curve25519-dalek/4.1.3/scalar/Scalar#Debug<&core::fmt::Formatter<'_>>#fmt()` (external-body)
...
- `probe:core/https://github.com/rust-lang/rust/library/core/array/Hash#hash()` (assume-specification)
- `probe:curve25519-dalek/4.1.3/core_assumes/bytes32_8_to_24()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/compressed_edwards_y_from_array_result()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/compressed_ristretto_from_array_result()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/first_32_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/last_32_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/negate_field()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/sha256_hash_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/sha512_hash_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/try_into_32_bytes_array()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u128_from_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u128_to_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u16_from_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u16_to_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u32_from_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u32_to_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u64_from_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/u64_to_le_bytes()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/write_bytes32_8_to_24()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/zeroize_bool()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/zeroize_bytes32()` (external-body)
- `probe:curve25519-dalek/4.1.3/core_assumes/zeroize_limbs5()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/CompressedEdwardsY#Debug<&core::fmt::Formatter<'_>>#fmt()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsBasepointTable#Clone#clone()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint#MultiscalarMul<J>#multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint#VartimeMultiscalarMul<J>#optional_multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint<&I>#iter_count()` (external-body)
- `probe:curve25519-dalek/4.1.3/edwards/EdwardsPoint<I>#sum_original()` (external-body)
- `probe:curve25519-dalek/4.1.3/field/u64/serial/backend/FieldElement51#Debug<&core::fmt::Formatter<'_>>#fmt()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/clone_optional_ristretto_iter_with_spec()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/clone_ristretto_iter_with_spec()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/collect_edwards_from_ristretto_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/collect_optional_edwards_from_ristretto_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/collect_optional_points_from_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/collect_points_from_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/collect_ristretto_points()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/collect_scalars_from_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/vec_to_edwards_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/iterator_specs/specs/vec_to_optional_edwards_iter()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint#MultiscalarMul<J>#multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint#VartimeMultiscalarMul<J>#optional_multiscalar_mul()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint<&R>#random()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint<&Vec<FieldElement>>#batch_invert_vec()` (external-body)
- `probe:curve25519-dalek/4.1.3/ristretto/RistrettoPoint<I>#sum_original()` (external-body)
- `probe:curve25519-dalek/4.1.3/scalar/Scalar#Debug<&core::fmt::Formatter<'_>>#fmt()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/choice_and()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/choice_into()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/choice_not()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/choice_or()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_assign_field_element()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_assign_generic()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_assign_u64()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_negate_affine_niels()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_negate_field_element()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_negate_generic()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_negate_projective_niels()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_select_field_element()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_select_u64()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_swap_montgomery_projective()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/conditional_swap_u64()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_eq_bytes32()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_eq_limbs5()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_eq_u16()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_eq_u8()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_option_is_none()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_option_is_some()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_option_new()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/ct_option_unwrap()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/negate_field_element()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/select()` (external-body)
- `probe:curve25519-dalek/4.1.3/subtle_assumes/u64/serial/backend/select_u8()` (external-body)
- `probe:curve25519-dalek/4.1.3/window/LookupTable#Clone#clone()` (external-body)
- `probe:curve25519-dalek/4.1.3/window/LookupTable#Debug<&core::fmt::Formatter<'_>>#fmt()` (external-body)
- `probe:subtle/2.6.1/Choice#From#from()` (assume-specification)
- `probe:subtle/2.6.1/Choice#unwrap_u8()` (assume-specification)
- `probe:subtle/2.6.1/ConditionallySelectable#conditional_assign()` (assume-specification)
- `probe:subtle/2.6.1/ConditionallySelectable#conditional_swap()` (assume-specification)
